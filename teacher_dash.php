    ...
    <body>
        <nav>
            <ul class="topnav" id="dropdownClick">
                <li><a href="teacher_dash.php" class="navbrrr"><img src="assets/classroomioDark.png" height=50px width=50px></a></li>
        ...
        <div class="row">
            <div class="col3">
                <div class="personaHolder">
                    <div class="proPicHolder">
                        <img src ="<?php include('image_print.php');?>" height=100%px width=100%>
                    </div>
            ...
            <div class="col6">
                <div class="notsNPosts">
					<div id="forum" >
						...
						<form action="fin_php.php" method="POST" enctype="multipart/form-data">
							Input:
							<input type="text" style="width:95%;margin-left:20px;margin-right:20px;" size="100%" name="INP"/>
							<textarea style="width:95%;margin-left:20px;margin-right:20px;height:40%;" rows="20" cols="20" name="content"></textarea>
							<input type="file" name="file" id="homework">
            ...
            <div class="col3">
                <div class="randomBox">
					...
					<button onclick="window.location.href='chat_room.php'" style="margin:auto;">Chat Room</button>
					<div class="homeworkContainer">
					Upload Homework
					<form action="upload.php" method="post" enctype="multipart/form-data" >
						Select image to upload<br>
						<input type="file" name="file" id="fileToUpload" class="fileToUpload">
						<input type="submit" value="Upload PDF" name="submit" class="fileToUpload">
					</form>
						<div align="center">
							<?php include('download_submissions.php')?>
						</div>
					</div>
				</div>
            </div>
